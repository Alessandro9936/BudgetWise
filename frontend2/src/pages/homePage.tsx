    ...
    <>
      <div className="flex h-screen w-full flex-col">
        ...
        <motion.section
          ...
          initial="initial"
          animate="visible"
          className="mt-10 flex flex-col items-center justify-between gap-5 lg:my-auto lg:mx-10 lg:flex-row lg:gap-20"
        >
          <motion.img
          ...
          />
          <div className="mx-8 flex max-w-[700px] flex-col items-center gap-y-10 midsm:mx-14 md:mx-20 lg:order-1 lg:mx-0 lg:ml-14 lg:items-start ">
            <motion.h1
              variants={childVariants}
